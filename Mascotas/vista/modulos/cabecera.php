...
<head>
    ...
    <script src="vista/js/cl_raza.js" defer></script>
    <script src="vista/js/cl_tipoDeMascota.js" defer></script>
    <script src="vista/js/cl_usuario.js" defer></script>
</head>
